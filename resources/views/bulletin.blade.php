...
<body>
    <div class="container table-container" id="print">
        <table class="table table-bordered">
            ...
            <tbody>
                <td>
                    <span class="label">{{$employee->nom}} {{$employee->prenom}}</span>
                </td>
                <td>
                    <span class="label">{{$employee->emploi}}</span>
                </td>
                <td>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr class="highlight-yellow custom-header custom-border-top custom-border-bottom">
                <td>Total brut</td>
                <td colspan="5">{{number_format($total_brut_salary,2)}}</td>
            </tr>
            <tr>
                <td>Cnss</td>
                {{-- <td></td> --}}
                ...
                <td>{{number_format($tcotisSal->cnss * $total_brut_salary,2)}}</td>
                <td>{{number_format($tcotisPat->cnss * $total_brut_salary,2)}}</td>
            </tr>
            <tr>
                <td>Pension</td>
                {{-- <td></td> --}}
                ...
                <td>{{number_format($tcotisSal->Pension * $total_brut_salary,2)}}</td>
                <td>{{number_format($tcotisPat->Pension * $total_brut_salary,2)}}</td>
            </tr>
            <tr>
                ...
                <td>{{number_format($tcotisSal->Presfamil * $total_brut_salary,2)}}</td>
                <td>{{number_format($tcotisPat->Presfamil * $total_brut_salary,2)}}</td>
            </tr>
            <tr>
                ...
                <td>{{number_format($tcotisSal->AMOoblSol * $total_brut_salary,2)}}</td>
                <td>{{number_format($tcotisPat->AMOoblSol * $total_brut_salary,2)}}</td>
            </tr>
            <tr>
                ...
                <td>{{number_format($tcotisSal->Taxpro * $total_brut_salary,2)}}</td>
                <td>{{number_format($tcotisPat->Taxpro * $total_brut_salary,2)}}</td>
            </tr>
            <tr>
                <td>Amo</td>
                {{-- <td></td> --}}
                ...
                <td>{{number_format($tcotisSal->amo * $total_brut_salary,2)}}</td>
                <td>{{number_format($tcotisPat->amo * $total_brut_salary,2)}}</td>
            </tr>
            ...
            <tr class="highlight-pink custom-header custom-border-top custom-border-bottom">
                ...
                <td colspan="5">{{number_format($total_net_salary,2)}} DH</td>
            </tr>
            {{-- <tr class="highlight-green custom-header custom-border-top custom-border-bottom">
                <td>NET A PAYER AVANT IMPOT SUR LE REVENU</td>
                <td colspan="6">2 465,87</td>
            </tr> --}}
        </tbody>
    </table>
</div><button class="btn btn-primary print-button" onclick="printDiv('print')">
